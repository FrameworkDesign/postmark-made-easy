...
namespace Weareframework\PostmarkMadeEasy\Library\Files;
...
class File
{
    ...
    public function __construct(Config $config, Manager $manager, Yaml $yaml, Sites $sites) {
        ...
        $this->yaml = $yaml;
        $this->configFile = $config->get('statamic.postmark-made-easy.file');
    ...
    private function file() {
        return base_path("content/postmark-made-easy/{$this->configFile}_{$this->locale}.yaml");
    }
    ...
    private function cacheKey() {
        return "postmark_made_easy_settings_{$this->locale}";
    }
}
